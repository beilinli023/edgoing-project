...
export interface ApiBlogpostBlogpost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    programtype: Schema.Attribute.Relation<
      'oneToOne',
      'api::programtype.programtype'
    >;
    publishedAt: Schema.Attribute.DateTime;
    Slideshow: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiBlogvideoBlogvideo extends Struct.CollectionTypeSchema {
  collectionName: 'blogvideos';
  info: {
    description: '';
    displayName: 'blogvideo';
    pluralName: 'blogvideos';
    singularName: 'blogvideo';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiCustomFormCustomForm extends Struct.CollectionTypeSchema {
  collectionName: 'custom_forms';
  info: {
    displayName: 'CustomForm';
    pluralName: 'custom-forms';
    singularName: 'custom-form';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiFormSubmissionFormSubmission
  ...
  attributes: {
    agreeToReceiveInfo: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    city: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    programTypes: Schema.Attribute.String;
...
export interface ApiGradeGrade extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    gradename: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProgramProgram extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    camp_period: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    program_id: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    programtypes: Schema.Attribute.Relation<
      'manyToMany',
      'api::programtype.programtype'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProgramsheroProgramshero
  extends Struct.CollectionTypeSchema {
  collectionName: 'programsheroes';
  info: {
    description: '';
    displayName: 'programhero';
    pluralName: 'programsheroes';
    singularName: 'programshero';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::programshero.programshero'
    >;
    programhero: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiStudyabroadheroStudyabroadhero
  extends Struct.CollectionTypeSchema {
  collectionName: 'studyabroadheroes';
  info: {
    displayName: 'studyabroadhero';
    pluralName: 'studyabroadheroes';
    singularName: 'studyabroadhero';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::studyabroadhero.studyabroadhero'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiUniversityUniversity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    academics: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    admission: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::blogvideo.blogvideo': ApiBlogvideoBlogvideo;
      'api::country.country': ApiCountryCountry;
      'api::custom-form.custom-form': ApiCustomFormCustomForm;
      ...
      'api::programshero.programshero': ApiProgramsheroProgramshero;
      'api::programtype.programtype': ApiProgramtypeProgramtype;
      'api::student-story.student-story': ApiStudentStoryStudentStory;
      'api::studyabroadhero.studyabroadhero': ApiStudyabroadheroStudyabroadhero;
